...
public class PrendreVoiture extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        code.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0), 2));
        ...
        jLabel3.setText("PRENDRE VOITURE :");
            ...
            if(res.next()){
                ...
                if(cin.equals(client.getCin()) ){
                    ...
                    if(etat.equals("en marche") && disponibilite.equals("disponible")){
                        ...
                        pstmt.setString(1,remboursement.getIdLocation());
                        pstmt.setDouble(2, remboursement.getMontant());
                        pstmt.executeUpdate();
                        ...
                        JOptionPane.showMessageDialog(null," DESOLEE VOTRE VOITURE N'EST PAS ENCORE DISPONIBLE "+ "VOICI UN REMBOURCEMENT DE 100 DT");
                    }
                }
                }else{
                     JOptionPane.showMessageDialog(null,"CETTE LOCATION N'EST PAD RESERVEE PAR VOUS "+"VEILLER VERIFIER VOTRE CODE DE LOCATION ");}
                }
            }else{JOptionPane.showMessageDialog(null,"PAS DE LOCATION AVEC CE CODE "+ "VEILLEZ VERIFIER VOTRE CODE DE LOCATION  !!!");}
        } catch (SQLException ex) {
