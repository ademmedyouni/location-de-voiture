                    ...
                    try {
                        ...
                        if(rs.next() ){
                            JOptionPane.showMessageDialog(null, "cette voiture existe deja");
                                ...
                                Voiture voiture = new Voiture(matriculeV, marqueV, modelV, etat, disp, Float.parseFloat(prixV),0);
                                String query2 = "INSERT INTO voiture VALUES (?,?,?,?,?,?,?)";

                                try (PreparedStatement stmt1 = con.prepareStatement(query2)) {
                                    stmt1.setString(1,voiture.getMatricule());
                                    stmt1.setString(2, voiture.getMarque());
                                    stmt1.setString(3, voiture.getModel());
                                    stmt1.setString(4, voiture.getEtat());
                                    stmt1.setString(5, voiture.getDisponibilite());
