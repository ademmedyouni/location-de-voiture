...
public class addmec extends javax.swing.JInternalFrame {
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(confirm, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 43, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(55, 55, 55))
        );
    ...
    private void confirmActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_confirmActionPerformed
        ...
        if(!verif(cin_user)) {
            ...
            if(cin_user.equals("")){
                JOptionPane.showMessageDialog(null,"Veuiller remplir le CIN !!!", "Error", JOptionPane.ERROR_MESSAGE);
            }else{
                JOptionPane.showMessageDialog(null,"Veuiller verifier le CIN !!!", "Error", JOptionPane.ERROR_MESSAGE);
            }
        }else{
            if (nom_user.equals("") | prenom_user.equals("") | tel_user.equals("") | date_user==null  | address_user.equals("")){
                JOptionPane.showMessageDialog(null,"Veuiller remplir tous les champs !!!", "Error", JOptionPane.ERROR_MESSAGE);
                ...
                if (!isValidEmailAddress(email_user)) {
                    JOptionPane.showMessageDialog(null,"l'email est invalide  !!!", "Error", JOptionPane.ERROR_MESSAGE);
                }else{
                    if (password_user.equals("")) {
                        JOptionPane.showMessageDialog(null,"Veuiller remplir le mot de passe !!!", "Error", JOptionPane.ERROR_MESSAGE);
                        ...
                        try {
                            ...
                            ResultSet rs=stmt.executeQuery(query);
                                if(rs.next() )
                                {
                                    JOptionPane.showMessageDialog(null,"CIN DEJA UTILISE  !!!", "Error", JOptionPane.ERROR_MESSAGE);
                                    ...
                                    try (PreparedStatement stmt1 = con.prepareStatement(query2)) {
                                        stmt1.setString(1, mec.getCin());
                                        stmt1.setString(2, mec.getNom());
                                        stmt1.setString(3, mec.getPrenom());
                                        stmt1.setString(4, mec.getPrenom());
                                        stmt1.setDate(5, sqlDate1); // Assuming sqlDate1 is your java.sql.Date object
                                        stmt1.setString(6, mec.getEmail());
                                        stmt1.setString(7, mec.getTel());
                                        stmt1.setString(8, mec.getAddress());
                                        stmt1.setString(9, mec.getMot_de_pass());
